class Vertice:
    ...
    def __init__(self, cidade, distancia_objetivo):
        self.cidade = cidade
        self.visitado = False
...
class VetorOrdenado:
    ...
    def imprime(self):
        if self.ultima_posicao == -1:
            ...
            for i in range(self.ultima_posicao + 1):
                mensagem = f'{i} - {self.valores[i].vertice.cidade} - {self.valores[i].custo} - {self.valores[i].vertice.distancia_objetivo} - [{self.valores[i].distancia_aestrela}]'
                print(mensagem)
